...
class ProductEndpoint extends BaseExtend {
  getAllProducts: IDigiApi<IResGetProducts, any> = async () => {
  ...
  addNewBundleProduct = async (
    payload: IReqAddNewBundleProduct
  ...
  getProductByCategoryId = async (payload: IReqGetProductByCategoryId): Promise<IResponse<IProductInCart[]>> => {
  ...
  addProductToQuoteBySku = async (payload: IReqAddProductToQuoteBySku): Promise<IResponse<IResAddProductToQuote>> => {
